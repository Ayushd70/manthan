...
abstract final class StorageEncryptionMigrator {
  ...
  static void _migrateSessions(
    Box<ChatSessionEntity> box,
    FieldCipher cipher,
  ) {
  ...
  static void _migrateMessages(
    Box<ChatMessageEntity> box,
    FieldCipher cipher,
  ) {
    final all = box.getAll();
    for (final entity in all) {
  ...
  static void _migrateDocuments(
    Box<DocumentEntity> box,
    FieldCipher cipher,
  ) {
    final all = box.getAll();
    for (final entity in all) {
  ...
  static void _migratePrompts(
    Box<SavedPromptEntity> box,
    FieldCipher cipher,
  ) {
    final all = box.getAll();
    for (final entity in all) {
